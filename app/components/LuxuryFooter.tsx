...
export default function LuxuryFooter() {
  ...
  // Toggle this to true to bring the footer menu back.
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl px-6 pt-3 pb-5">
        {/* --- Footer Menu (kept in code, disabled by toggle) --- */}
        {SHOW_FOOTER_MENU && (
        ...
        {/* Divider (only if menu is shown) */}
        {SHOW_FOOTER_MENU && <hr className="mt-6 border-t border-white/10" />}
